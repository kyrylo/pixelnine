...
{Screenshot1}[http://img-kiev.fotki.yandex.ru/get/5302/curacaothe.1/0_525c2_3f7f0f7_orig]
{Screenshot2}[http://img-kiev.fotki.yandex.ru/get/4404/curacaothe.1/0_525c3_86af462_orig]
...
There are two directories and three files at top-level. The <em>pixenine</em>
directory contain all PNGs. You can manually zip them to <em>tar.gz</em>
archive. When you do that, you'll have a skin package. To install it, read
<em>step 2</em> of installation guide. The <em>xcf</em> directory holds GIMP
files. This is where you come in as designer. <em>Xcf's</em> directory structure
is similar to <em>pixelnine</em>. After editing the <em>.xcf</em>, you have to
export PNG to <em>pixelate</em> directory. Make an archive from this directory
and then install it. Oh, and don't forget about two configuration <em>.skin</em>
files.
